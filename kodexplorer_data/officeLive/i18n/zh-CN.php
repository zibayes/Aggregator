<?php
return array(
	"officeLive.meta.name"				=> "Collabora",
	"officeLive.meta.title"				=> "Collabora",
	"officeLive.meta.desc"				=> "Collabora",
	...
	"officeLive.Config.apiServerDesc"	=> "<div class='can-select pt-10'>
		...
		<div class='grey-8'>http://127.0.0.1:8000/kodexplorer-proxy/?path=</div><br/>
