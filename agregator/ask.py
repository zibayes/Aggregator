...
from .query_templates import DB_QUERY_TEMPLATE, SOURCE_TEMPLATE, RESULT_TEMPLATE, \
    PROMPT_TEMPLATE, INFO_SOURCES, REFORMULATE_TEMPLATE, SIMPLE_QUESTION_TEMPLATE
...
vectorstore = Chroma(embedding_function=get_embeddings(), persist_directory="path_to_your_chroma_db")
