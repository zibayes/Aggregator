...
urlpatterns = [
    ...
    path('api/check_external_scan_progress/<str:task_id>/', views.check_external_scan_progress,
         name='check_external_scan_progress'),
    path('api/cancel_external_scan_task/<str:task_id>/', views.cancel_external_scan_task,
    ...
    path('api/scientific_reports/<int:pk>/', views.ScientificReportDetail.as_view(), name='scientificreport-detail'),
