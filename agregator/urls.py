...
urlpatterns = [
    ...
    path('api/check_scan_progress/<str:task_id>/', views.check_scan_progress, name='check_scan_progress'),
    path('api/cancel_scan_task/<str:task_id>/', views.cancel_scan_task, name='cancel_scan_task'),
